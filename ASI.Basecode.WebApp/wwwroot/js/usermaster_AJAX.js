        ...
        fetch(`/Admin/GetUserForEdit?userId=${userId}`)
            ...
            .then(user => {
                ...
                if (user.profilePicture) {
                    ...
                    if (existingProfilePictureInput) existingProfilePictureInput.value = user.profilePicture;
                } else {
                ...
                if (editUserName) editUserName.textContent = `${user.firstName} ${user.lastName}`;
